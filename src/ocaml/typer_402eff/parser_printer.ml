...
let print_symbol = function
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_UIDENT) -> "<ident>"
  ...
  | MenhirInterpreter.X (MenhirInterpreter.T MenhirInterpreter.T_LIDENT) -> "<ident>"
...
let print_value (type a) : a MenhirInterpreter.symbol -> a -> string = function
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_NATIVEINT -> (Printf.sprintf "NATIVEINT(%nd)")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_INT64 -> (Printf.sprintf "INT64(%Ld)")
  | MenhirInterpreter.T MenhirInterpreter.T_INT32 -> (Printf.sprintf "INT(%ld)")
  | MenhirInterpreter.T MenhirInterpreter.T_INT -> (Printf.sprintf "INT(%d)")
  ...
  | MenhirInterpreter.T MenhirInterpreter.T_FLOAT -> (Printf.sprintf "FLOAT(%S)")
